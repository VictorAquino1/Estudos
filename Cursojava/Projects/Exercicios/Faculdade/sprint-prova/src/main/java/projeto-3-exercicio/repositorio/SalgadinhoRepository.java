 ...
 */
    ...
    Long countByApimentadoFalse();
    List<Salgadinho> findByNivelSalLessThan(Integer nivel);
    List<Salgadinho> findByPrecoGreaterThanEqual(Double valor);
    List<Salgadinho> findByPrecoBetween(Double preco1, Double preco2);
    List<Salgadinho> findByNomeContains(String nome);
    List<Salgadinho> findByPrecoBetweenAndApimentadoOrderByPrecoDesc(Double preco1, Double preco2, Boolean apimentado);
}
